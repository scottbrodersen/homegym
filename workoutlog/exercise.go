...
type ExerciseAdmin interface {
	NewExerciseType(userID, name, intensity, volume string, volConstraint int) (*string, error)
	UpdateExerciseType(userID, exerciseID, name, intensity, volume string, volConstraint int) error
...
func (ea *exerciseManager) NewExerciseType(userID, name, intensity, volume string, volumeConstraint int) (*string, error) {
	id := uuid.New().String()
...
func (ea *exerciseManager) UpdateExerciseType(userID, exerciseID, name, intensity, volume string, volConstraint int) error {
...
func (m *mockExerciseManager) NewExerciseType(userID, name, intensity, volume string, volConstraint int) (*string, error) {
	args := m.Called(userID, name, intensity, volume, volConstraint)
...
func (m *mockExerciseManager) UpdateExerciseType(userID, exerciseID, name, intensity, volume string, volConstraint int) error {
	args := m.Called(userID, name, intensity, volume, volConstraint)
