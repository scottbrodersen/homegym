...
func createExerciseTypes() error {
	id, err := workoutlog.ExerciseManager.NewExerciseType(username, "squat", "weight", "count", 1)
	if err != nil {
		return err
	}
	...
	id, err = workoutlog.ExerciseManager.NewExerciseType(username, "snatch", "weight", "count", 2)
	if err != nil {
		return err
	}
